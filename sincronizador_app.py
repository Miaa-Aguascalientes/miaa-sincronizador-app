        ...
        with eng_pg.begin() as conn:
            for _, row in df.iterrows():
                ...
                if id_val and id_val != "nan":
                    ...
                    if sets:
                        # CAMBIO: Se usa el esquema "Agua_potable" y el objeto text() para Postgres
                        sql_upd = text(f'UPDATE "Agua_potable"."Pozos" SET {", ".join(sets)} WHERE "ID" = :id')
